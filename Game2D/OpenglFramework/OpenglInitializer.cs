...
namespace Game2D.Opengl
{
    class OpenglInitializer
    {
        ...
        public static int CreateWindow(int width, int height, bool tryFullScreen )
        {
            ...
            return Glut.glutCreateWindow(ConfigOpengl.WindowName);
        }
        ...
        public static void SetDisplayModes()
        {
            ...
            Glu.gluOrtho2D(0.0, ConfigOpengl.ScreenWidth, ConfigOpengl.ScreenHeight, 0 );
        ...
        public static Dictionary<string, int> LoadTextures()
        {
            ...
            foreach (var tex in ConfigOpengl.Sprites)
            {
                int code = TextureInit(ConfigOpengl.Sprites[tex.Key].file);
